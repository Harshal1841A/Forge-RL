...
description: "Review API designs for REST conventions, breaking changes, and best practices. Use when the user asks to review, lint, or score an API design, detect breaking changes between API versions, or validate OpenAPI/Swagger specifications."
---
