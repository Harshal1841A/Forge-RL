...
description: "Navigate, manage, and optimize monorepos. Use when the user asks about monorepo tooling, cross-package impact analysis, selective builds, dependency graphs, Turborepo, Nx, pnpm workspaces, or migrating from multi-repo to monorepo."
---
